...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "monthly_rent_cents": "الإيجار الشهري (ج.م)",
    "due_day": "يوم الاستحقاق",
    "late_fee_percent": "نسبة رسوم التأخير %",
    "security_deposit_cents": "مبلغ التأمين (ج.م)",
    "period": "الفترة",
    "rent": "الإيجار",
    "end": "إنهاء",
  ...
  en: {
    ...
    "end_date": "End Date",
    "monthly_rent_cents": "Monthly Rent (EGP)",
    "due_day": "Due Day",
    "late_fee_percent": "Late Fee %",
    "security_deposit_cents": "Security Deposit (EGP)",
    "period": "Period",
    "rent": "Rent",
    "end": "End",
